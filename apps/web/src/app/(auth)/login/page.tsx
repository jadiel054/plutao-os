    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 bg-[var(--base)] text-[var(--text-primary)]">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-xl font-bold tracking-tight">Entrar no Plutão</h1>
          <p className="text-xs text-[var(--text-muted)]">Insira seus dados para acessar o cockpit</p>
        </div>
        ...
        <p className="text-center text-xs text-[var(--text-secondary)]">
          Não tem uma conta?{" "}
          <Link href="/register" className="text-[var(--nucleo)] hover:underline font-medium">
            Criar conta
          </Link>
        </p>
      </div>
